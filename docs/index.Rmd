...
I used this general framework for each of my 6 models with some slight variations depending on the model. One-hot encoding was used for the XGBoost recipe.
...
vip_df %>% 
  ...
  ggplot() +
  geom_col(aes(x = Importance, y = reorder(Variable, Importance), fill = Sign)) +
  ggplot2::labs(
    title = "Variable Importance - Logisitc Regression",
    y = "Variable"
  ) + 
  apatheme +
  ggplot2::theme(
