...
# Modeling
I decided I wanted to run my data across a suite of 7 different models and see how they all perform against eachother 
...
## Data Budget/Splits
The first step was to split up our data into testing and training splits, 75% training 25% testing. I chose to do some stratified resampling using the our binary win value to ensure there was an even distribution of wins and losses in our training and testing splits. 

## Data Preprocessing
Using the recipes package, I made ID variables for information about the game and when it happened. I then applied some recipe steps to my training data.
